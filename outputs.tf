...
output "app_names" {
  ...
  value = {
    for k, v in module.app : k => v.name
  }
}
...
output "aad_client_secret_setting_names" {
  ...
  value = {
    for k, v in module.app : k => v.aad_client_secret_setting_name
  }
}
...
output "identity_principal_ids" {
  ...
  value = {
    for k, v in module.app : k => v.identity_principal_id
  }
}
