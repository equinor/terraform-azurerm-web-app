...
output "app_names" {
  ...
  value = {
    for k, v in local.apps : k => v.name
  }
}
...
output "aad_client_secret_setting_names" {
  ...
  value = {
    for k, v in local.apps : k => v.aad_client_secret_setting_name
  }
}
...
output "identity_principal_ids" {
  ...
  value = {
    for k, v in local.apps : k => v.identity_principal_id
  }
}
