...
variable "active_directory_client_secret_setting_name" {
  description = "The name of an app setting containing a client secret for the Microsoft Entra app registration to use for built-in authentication. Required if the client is a confidential client application (https://learn.microsoft.com/en-us/entra/identity-platform/msal-client-applications)."
  type        = string
  nullable    = false
